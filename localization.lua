...
Results will print here when done.]],
  ...
  ["You have gained %d AuxStanding."] = "You have gained %d AS.",
  ...
  ["Giving %d AuxStanding to all raidmembers"] = "Giving %d AS to all raidmembers",
  ...
  ["Giving %d AuxStanding to active reserves"] = "Giving %d AS to active reserves",
  ["Giving %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "Giving %d AS to %s%s. (Previous: %d, New: %d)",
  ["%s MainStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s PS Penalty to %s%s. (Previous: %d, New: %d)",
  ["%s AuxStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s AS Penalty to %s%s. (Previous: %d, New: %d)",  
  ["%s\'s officernote is broken:%q"] = true,
  ["All Standing decayed by %d%%"] = true,
  ["All Standing decayed by %s%%"] = true,
  ["All AuxStanding has been reset to %d."] = "All AS has been reset to %d.",
  ["All Standing has been reset to 0/%d."] = true,
  ["You now have: %d MainStanding %d AuxStanding + (%d)"] = "You now have: %d PS %d AS + (%d)",
  ...
  ["Account AuxStanding to %s."] = "Account AS to %s.",
  ...
  ["+AuxStanding to Raid"] = "+AS to Raid",
  ["Award MainStanding to all raid members."] = "Award PS to all raid members.",
  ["Award AuxStanding to all raid members."] = "Award AS to all raid members.",
  ["+AuxStanding to Member"] = "+AS to Member",
  ["Account AuxStanding for member."] = "Account AS for member.",
  ...
  ["Reset Standing"] = true,
  ["Reset AuxStanding"] = "Reset AS",
  ["Resets everyone\'s Standing to 0/%d (Admin only)."] = "Resets everyone\'s Standing to 0/%d (Admin only).",
  ["Resets everyone\'s AuxStanding to 0/%d (Admin only)."] = "Resets everyone\'s AS to 0/%d (Admin only).",
  ...
  ["|cffff0000Are you sure you want to Reset ALL AuxStanding?|r"] = "|cffff0000Are you sure you want to Reset ALL AS?|r", 
  ["AuxStanding Actions"] = "AS Actions",
...
完成后打印结果.]],
  ...
  ["You have gained %d AuxStanding."] = "你得到了 %d AS.",
  ...
  ["Giving %d AuxStanding to all raidmembers"] = "给予 %d AS 到所有团员",
  ...
  ["Giving %d AuxStanding to active reserves"] = "给予 %d AS 在线的替补队员",
  ["Giving %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "给予 %d AS 给 %s (以前: %d, 新: %d)", 
  ["%s MainStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s PS 惩罚 %s. (以前: %d, 新: %d)",
  ["%s AuxStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s AS 惩罚 %s. (以前: %d, 新: %d)",
  ["Awarding %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "奖励 %d AS 给 %s. (以前: %d, 新: %d)",
  ...
  ["All AuxStanding has been reset to %d."] = "所有AS已重置为 %d.",
  ["All Standing has been reset to 0/%d."] = "所有Standing已重置为 0/%d.",
  ["You now have: %d MainStanding %d AuxStanding + (%d)"] = "你现在有: %d PS %d AS + (%d) ",
  ...
  ["Account AuxStanding to %s."] = "记账 AS 到 %s.",
  ...
  ["+AuxStanding to Raid"] = "+AS 给团队",
  ["Award MainStanding to all raid members."] = "奖励 PS 给所有团队成员.",
  ["Award AuxStanding to all raid members."] = "奖励 AS 给所有团队成员.",
  ["+AuxStanding to Member"] = "+AS 给成员",
  ["Account AuxStanding for member."] = "记账 AS 给成员.",
  ["+MainStanding to Reserves"] = "+PS给替补队员",
  ["Award MainStanding to all active Reserves."] = "奖励PS给所有在线的替补队员.",
  ...
  ["Offspec Price %"] = "副天赋价值 %",
  ["Set Offspec Items AuxStanding Percent."] = "设置副天赋物品 AS 百分比.",
  ...
  ["|cffff0000Are you sure you want to Reset ALL AuxStanding?|r"] = "|cffff0000您确定要重置全部 AS?|r",
  ["Add MainSpec AuxStanding"] = "添加主天赋 AS",
  ["Add OffSpec AuxStanding"] = "添加副天赋 AS",
  ["Bank or D/E"] = "公会银行或分解师",
  ["%s looted %s. What do you want to do?"] = "%s 拾取了 %s. 你想做什么？",
  ["AuxStanding Actions"] = "AS 操作",
